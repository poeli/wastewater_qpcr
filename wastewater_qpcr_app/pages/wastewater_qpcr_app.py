...
def generate_ai_summary(data_frames, selected_pathogen, model=modal_name):
    """
    ...
    try:
        ...
        summary = "AI summary: " + response.choices[0].message.content
    ...
    [
        dbc.CardBody(
            [
                ...
                html.Span(f"Generated by LANL AI portal: {modal_name}", style={"font-size": "0.8rem"}),
            ],
